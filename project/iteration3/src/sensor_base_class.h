...
class SensorBaseClass {
 public:
  ...
  SensorBaseClass(void) :
    activated_(0), entity_(NULL), range_(0.0), field_of_view_(0.0) {}

  /**
   * @brief Constructor
   */
  SensorBaseClass(int a, ArenaEntity* e, double r, double f) :
    activated_(a), entity_(e), range_(r), field_of_view_(f) {}

  /**
  * @brief Copy Constructor
  */
  SensorBaseClass(const SensorBaseClass& other) :
    SensorBaseClass(other.activated_, other.entity_,
      other.range_, other.field_of_view_) {}

  /**
  * @brief overload operator=
  */
  SensorBaseClass& operator=(const SensorBaseClass& other) {
