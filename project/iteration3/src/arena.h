...
class Arena {
  ...
  */
  double ProximityInRange(const class ArenaEntity* const ent1,
               const class ArenaEntity* const ent2,
               double distance);

  /**
  * @brief update the collision event of robot
  */
  void UpdateRobotCollisionEvent(class Robot* robot,
                                 EventCollision * const event);

  /**
  * @brief update the collision event
  */
 ...
 /**
 * @brief helper function to make event angle Postive in range 0 to 360
 */
